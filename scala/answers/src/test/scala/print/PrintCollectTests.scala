...
object PrintCollectTests extends Properties("PrintCollect") {
  ...
  // notice the difference between PrintStdOut and PrintCollect:
  // we can actually tests that our print statements are working.
  // this would be analogous to testing a logger.
